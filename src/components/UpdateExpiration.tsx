...
export const UpdateExpiration: FC<props> = ({
  isLoading,
  setIsLoading,
  reload,
  user,
  ...
  const isSame =
    expiration === parseDateStr(form.watch("expiration_date")) ||
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Update the expiration date of {user.name}. Click save when you are
              done.
            </DialogDescription>
          </DialogHeader>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Input id="date update" {...field} type="date"></Input>
                    <FormDescription>
                      <ShowExpiration
                        expiration={expiration}
                        content="Current expiration date:"
                      />
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
...
export const UpdateAllExpiration: FC<AllProps> = ({
  isLoading,
  setIsLoading,
  reload,
  users,
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Update the expiration dates of all {users.length} students in this
              class. Click save when you are done.
            </DialogDescription>
          </DialogHeader>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      <ShowExpiration
                        expiration={eariliestExpiration}
                        content="Eariliest expiration date:"
                      />
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
