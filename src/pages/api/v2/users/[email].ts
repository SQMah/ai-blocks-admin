...
import {  deleteUserReqSchema, getUserReqSchema ,putUsersReqSchema } from "@/models/api_schemas";
import { TaskHandler } from "@/lib/task-handler";
import { getUserByEmail, updateUser } from "@/lib/drizzle_functions";


const handleGet = async (req: NextApiRequest, res: NextApiResponse) => {
  try {
    const {email}  = getUserReqSchema.parse(req.query)
