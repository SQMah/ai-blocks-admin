...
import { deleteGroup, getGroupById, updateGroup } from "@/lib/drizzle_functions";
import { deleteGroupsReqSchema, getGroupByIdReqSchema, putGroupsReqSchema } from "@/models/api_schemas";
...
const handleGet = async (req: NextApiRequest, res: NextApiResponse) => {
  try {
    const {group_id} = getGroupByIdReqSchema.parse(req.query)
