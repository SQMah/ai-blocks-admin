import { pgTable, index, foreignKey, pgEnum, text, boolean, timestamp, serial, uniqueIndex, varchar, integer } from "drizzle-orm/pg-core"

import { sql } from "drizzle-orm"
export const groupType = pgEnum("GroupType", ['class', 'family'])
export const userRole = pgEnum("UserRole", ['student', 'teacher', 'admin', 'parent'])
...
export const userModuleProgress = pgTable("UserModuleProgress", {
	...
	pagesCompleted: text("pages_completed").default('RRAY[').array(),
